...
main:				; the program label for the entry point
        ...
        ;mov rax, [a]             ; Move a for print
        ;call print_rax          ;

        mov RCX, [calsz]        ; calibration list size
        mov RDX, calseq         ; pointer to the list
        mov RBX, 0              ; the sum in RBX
        mov r12, [seen]         ; counter for seen values
        mov r13, seen + 8       ; ptr to the list of seen values
        mov r14, r13            ; ptr to the list of seen values to be modified

top:
        add RBX, [RDX]
        add RDX, 8
        dec RCX
        inc r12                 ; increment the counter of seen values 
        mov [r14], RBX          ; put the value in the list of seen
        add r14, 8              ; move the pointer to the next
